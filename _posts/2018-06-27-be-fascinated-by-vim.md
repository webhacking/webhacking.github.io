...
이 작업이 본인의 일에 있어 차지하는 비중이 매우 낮았기 때문이라 핑계를 대고 싶다.
...
그 날로 IDE에 Vim 관련 플러그인을 설치하고, [vim cheat sheet](https://vim.rtorr.com/) 을 프린트하여 앞에두고 강제적으로 Vim 을 사용했다. (IDE 의 경우, jetbrains 사 제품군을 기준으로 하고있지만 타 제품군의 IDE 도 Vim 관련 플러그인을 쉽게 찾을 수 있다.)
...
이전에는 계속 'magic keyboard' 만을 고집해서 사용했다.
